...
--
-- Host: localhost
-- Generation Time: Nov 15, 2011 at 07:18 PM
...
CREATE TABLE IF NOT EXISTS `danh_muc` (
  `idDanhmuc` int(10) unsigned NOT NULL AUTO_INCREMENT,
...
ALTER TABLE `phuong_xa`
  ADD CONSTRAINT `phuong_xa_ibfk_1` FOREIGN KEY (`Quan_huyen_idQuan_huyen`) REFERENCES `quan_huyen` (`idQuan_huyen`) ON DELETE NO ACTION ON UPDATE NO ACTION;

--
-- Constraints for table `quan_huyen`
--
ALTER TABLE `quan_huyen`
  ADD CONSTRAINT `quan_huyen_ibfk_1` FOREIGN KEY (`Tinh_thanh_pho_idTinh_thanh_pho`) REFERENCES `tinh_thanh_pho` (`idTinh_thanh_pho`) ON DELETE NO ACTION ON UPDATE NO ACTION;
...
ALTER TABLE `tinh_thanh_pho`
  ADD CONSTRAINT `tinh_thanh_pho_ibfk_1` FOREIGN KEY (`Quoc_gia_idQuoc_gia`) REFERENCES `quoc_gia` (`idQuoc_gia`) ON DELETE NO ACTION ON UPDATE NO ACTION;
