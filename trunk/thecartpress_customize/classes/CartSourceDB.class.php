...
class TCP_CartSourceDB implements TCP_ICartSource {
	...
	public $order; //order from Orders table

	public $orders_details;//details from OrdersDetails table
	public $orders_costs;//costs from OrdersCosts table

	public $see_address;
	public $see_sku;
	public $see_weight;
	public $see_tax;
	public $see_tax_summary;
	public $see_comment;
	public $see_other_costs;
	public $see_thumbnail;
