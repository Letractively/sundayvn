...
class EnmasseModelSaleReports extends JModel
{
      var $_total = null;
	  ...
	  function _buildContentOrderBy() // to generate order query content
	  {
       ...
       // minic the search function without having limit
       function getTotalSearch ($code, $name, $sale, $mer, $fromdate, $todate) {
	       	$db = JFactory::getDBO();
	 ...
	 function getPagination($code, $name, $sale, $mer, $fromdate, $todate)
	  {
	        //create pagination
	        if (empty($this->_pagination)) {
	            jimport('joomla.html.pagination');
	            //$this->_pagination = new JPagination($this->getTotal(), $this->getState('limitstart'), $this->getState('limit') );
	            $this->_pagination = new JPagination(count($this->getTotalSearch($code, $name, $sale, $mer, $fromdate, $todate)), $this->getState('limitstart'), $this->getState('limit') );
	        }
	        return $this->_pagination;
	  }
	  
//Kayla add to Search on Reports
