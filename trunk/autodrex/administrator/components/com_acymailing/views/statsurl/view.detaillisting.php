...
$query .= ' LEFT JOIN '.acymailing_table('url').' as c on a.urlid = c.urlid';
$query .= ' LEFT JOIN '.acymailing_table('subscriber').' as d on a.subid = d.subid';
...
if(!empty($pageInfo->search)){
	$countQuery .= ' LEFT JOIN '.acymailing_table('mail').' as b on a.mailid = b.mailid';
	$countQuery .= ' LEFT JOIN '.acymailing_table('url').' as c on a.urlid = c.urlid';
	$countQuery .= ' LEFT JOIN '.acymailing_table('subscriber').' as d on a.subid = d.subid';
}
