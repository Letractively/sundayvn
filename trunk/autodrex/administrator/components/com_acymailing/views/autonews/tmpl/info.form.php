...
<table class="adminform">
	...
	<tr>
		...
		<td>
			<?php if(empty($this->mail->senddate)) $this->mail->senddate = time(); echo JHTML::_('calendar', acymailing_getDate($this->mail->senddate,'%Y-%m-%d %H:%M'), 'data[mail][senddate]','senddate','%Y-%m-%d %H:%M','size="30"'); ?>
		</td>
		<td>
	...
	<tr>
		...
		<td>
			<input class="inputbox" type="text" name="data[mail][params][generateto]" id="generateto" size="50" value="<?php echo $this->escape(@$this->mail->params['generateto']); ?>" /> <?php echo $this->values->editnotification; ?>
		</td>
	</tr>
</table>