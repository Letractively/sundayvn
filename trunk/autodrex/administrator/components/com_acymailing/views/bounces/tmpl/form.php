...
<form action="index.php?option=com_acymailing&amp;ctrl=bounces" method="post" name="adminForm" autocomplete="off" id="adminForm" >
		<table class="paramlist admintable">
			<tr>
				...
				<td>
					<input type="text" name="data[rule][name]" id="name" class="inputbox" size="40" value="<?php echo $this->escape(@$this->rule->name); ?>" />
				</td>
			</tr>
			<tr>
				<td class="key">
				...
				<td>
					<?php echo JHTML::_('select.booleanlist', "data[rule][published]" , '',@$this->rule->published); ?>
				</td>
			</tr>
			<tr>
				<td class="key">
				...
				<td>
					#<input type="text" name="data[rule][regex]" id="regex" class="inputbox" size="100" value="<?php echo $this->escape(@$this->rule->regex); ?>" />#is
			...
			<tr>
				...
				<td>
					...
					<br/><label for="action_message_forward"><?php echo JText::_('FORWARD_EMAIL'); ?> </label> <input type="text" id="action_message_forward" size="40" name="data[rule][action_message][forwardto]" value="<?php echo @$this->rule->action_message['forwardto']; ?>"/>
				</td>
			</tr>
		</table>
