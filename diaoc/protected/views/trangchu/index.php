<div id="home_search" class="clearfix">
    <form action="" method="get">
        ...
        <select>
            ...
            <option>Từ 5 triệu - 10 triệu</option>
        </select>
        <input class="button" type="submit" value="Tìm tài sản" />
    ...
    <div id="home_left" class="clearfix">
        ...
        <div id="newest_property" class="plain_module">
            <div class="plain_module_title">
                <h3>Tài sản mới nhất<a href="#">Xem thêm</a></h3>
            </div>
        ...
        <div id="lowest_property" class="plain_module">
            <div class="plain_module_title">
                <h3>Tài sản giá thấp<a href="#">Xem thêm</a></h3>
            </div>
            <div class="two_div_property clearfix">
                <div class="left">
                    <div class="customize">
        ...
        <div id="highest_property" class="plain_module">
            <div class="plain_module_title">
                <h3>Tài sản cao cấp<a href="#">Xem thêm</a></h3>
            </div>
            <div class="two_div_property clearfix">
                <div class="left">
                    <div class="customize">
