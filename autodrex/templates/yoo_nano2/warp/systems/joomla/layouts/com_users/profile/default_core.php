...
<ul>
	<li><strong><?php echo JText::_('COM_USERS_PROFILE_NAME_LABEL'); ?></strong> <?php	echo $this->data->name; ?></li>
	<li><strong><?php echo JText::_('COM_USERS_PROFILE_USERNAME_LABEL'); ?></strong> <?php echo htmlspecialchars($this->data->username); ?></li>	<li><strong><?php echo JText::_('Email address'); ?>:</strong> <?php echo htmlspecialchars($this->data->email); ?></li>
