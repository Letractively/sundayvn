...
<fieldset class="adminform">
	...
	<a href="<?php echo acymailing_completeLink('followup&task=add&campaign='.$this->list->listid) ?>" title="<?php echo JText::_('FOLLOWUP_ADD')?>" ><img src="<?php echo '../images/M_images/new.png'; ?>" alt="<?php echo JText::_('FOLLOWUP_ADD',true)?>"/></a>
		...
		<tbody>
			...
			?>
				<tr class="<?php echo "row$k"; ?>" id="<?php echo $id; ?>">
					...
					<td>
					<a href="<?php echo acymailing_completeLink('followup&task=edit&mailid='.$row->mailid) ?>" title="<?php echo JText::_('EDIT')?>" >
