		...
		<table><tr><td>
			<table class="admintable" cellspacing="1">
				...
				<tr>
					...
					<td>
						<input type="text" size="40" name="config[bounce_server]" value="<?php echo $this->escape(trim($this->config->get('bounce_server',''))); ?>"/>
					</td>
				</tr>
				<tr>
					<td class="key">
					...
					<td>
						<input type="text" size="10" name="config[bounce_port]" value="<?php echo intval($this->config->get('bounce_port','')); ?>"/>
					</td>
				</tr>
				<tr>
					<td class="key">
				...
				<tr>
					...
					<td>
						<input type="text" size="30" name="config[bounce_username]" value="<?php echo $this->escape(trim($this->config->get('bounce_username',''))); ?>" />
					</td>
				</tr>
				<tr>
					<td class="key">
					...
					<td>
						<input type="password" autocomplete="off" size="30" name="config[bounce_password]" value="<?php echo $this->escape(trim($this->config->get('bounce_password',''))); ?>" />
					</td>
				</tr>
				<tr>
					<td class="key">
					...
					<td>
						<input type="text" size="10" name="config[bounce_timeout]" value="<?php echo intval($this->config->get('bounce_timeout','10')); ?>" />
					</td>
				</tr>
				<tr>
					<td class="key">
					...
					<td>
						<input type="text" size="10" name="config[bounce_max]" value="<?php echo intval($this->config->get('bounce_max',100)); ?>" />
					</td>
				</tr>
				<tr>
					<td class="key">
