	...
	<legend><?php echo JText::_( 'SUBSCRIPTION' ); ?></legend>
		<table class="admintable" cellspacing="1">
			...
			<tr>
				...
				<td>
					<input class="inputbox" id="configautosub" name="config[autosub]" type="text" size="20" value="<?php echo $this->escape($this->config->get('autosub','None')); ?>">
	...
	<fieldset class="adminform">
		...
		<table class="admintable" cellspacing="1">
			<tr>
				...
				<td>
					<input class="inputbox" type="text" name="config[notification_created]" size="50" value="<?php echo $this->escape($this->config->get('notification_created')); ?>">
			...
			<tr>
				...
				<td>
					<input class="inputbox" type="text" name="config[notification_unsub]" size="50" value="<?php echo $this->escape($this->config->get('notification_unsub')); ?>">
			...
			<tr>
				...
				<td>
					<input class="inputbox" type="text" name="config[notification_unsuball]" size="50" value="<?php echo $this->escape($this->config->get('notification_unsuball')); ?>">
			...
			<tr>
				...
				<td>
					<input class="inputbox" type="text" name="config[notification_refuse]" size="50" value="<?php echo $this->escape($this->config->get('notification_refuse')); ?>">
	...
	<fieldset class="adminform">
		...
		<table class="admintable" cellspacing="1">
			<tr>
				...
				<td>
					<input class="inputbox" type="text" id="sub_redirect" name="config[sub_redirect]" size="60" value="<?php echo $this->escape($this->config->get('sub_redirect')); ?>">
				</td>
			</tr>
			<tr>
				<td class="key">
				...
				<td>
					<input class="inputbox" type="text" id="modif_redirect" name="config[modif_redirect]" size="60" value="<?php echo $this->escape($this->config->get('modif_redirect')); ?>">
				</td>
			</tr>
			<tr>
				<td class="key">
				...
				<td>
					<input class="inputbox" type="text" id="confirm_redirect" name="config[confirm_redirect]" size="60" value="<?php echo $this->escape($this->config->get('confirm_redirect')); ?>">
				</td>
			</tr>
			<tr>
				<td class="key">
				...
				<td>
					<input class="inputbox" type="text" id="unsub_redirect" name="config[unsub_redirect]" size="60" value="<?php echo $this->escape($this->config->get('unsub_redirect')); ?>">
				</td>
			</tr>
		</table>
	</fieldset>
