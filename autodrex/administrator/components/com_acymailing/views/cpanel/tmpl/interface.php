...
<br  style="font-size:1px;" />
	...
	<fieldset class="adminform">
		...
		<tr>
			...
			<td>
				<?php echo JHTML::_('select.booleanlist', "config[show_colnumber]" , '',$this->config->get('show_colnumber',1) ); ?>
			</td>
		</tr>
		...
		<tr>
			...
			<td>
				<?php echo JHTML::_('select.booleanlist', "config[show_receiveemail]" , '',$this->config->get('show_receiveemail',0) ); ?>
			</td>
		</tr>
		<?php } ?>
		<tr>
			...
			<td>
				<?php echo JHTML::_('select.booleanlist', "config[open_popup]" , '',$this->config->get('open_popup',1) ); ?>
		...
		<table><tr><td>
			<table class="admintable" cellspacing="1">
				...
				<tr>
					...
					<td>
						<input type="text" size="40" name="config[acyrss_name]" value="<?php echo $this->escape($this->config->get('acyrss_name','')); ?>"/>
					</td>
				</tr>
				<tr>
					<td class="key">
