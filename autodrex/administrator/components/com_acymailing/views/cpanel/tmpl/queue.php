	...
	<legend><?php echo JText::_( 'QUEUE_PROCESS' ); ?></legend>
		...
		<?php if(acymailing_level(1)){?>
			...
			<tr id="method_auto">
				...
				<td>
					<?php echo JText::sprintf('SEND_X_EVERY_Y','<input class="inputbox" type="text" name="config[queue_nbmail_auto]" size="10" value="'.intval($this->config->get('queue_nbmail_auto')).'" />',$this->elements->cron_frequency); ?>
				</td>
			</tr>
			<?php } ?>
			<tr id="method_manual">
				...
				<td>
					<?php echo JText::sprintf('SEND_X_WAIT_Y','<input class="inputbox" type="text" name="config[queue_nbmail]" size="10" value="'.intval($this->config->get('queue_nbmail')).'" />',$this->elements->queue_pause); ?>
				</td>
			</tr>
			<tr>
				<td class="key">
				...
				<td>
					<?php echo JText::sprintf('CONFIG_TRY','<input class="inputbox" type="text" name="config[queue_try]" size="2" value="'.intval($this->config->get('queue_try')).'">');
	...
	<legend><?php echo JText::_( 'PRIORITY' ); ?></legend>
		<table class="admintable" cellspacing="1">
			<tr>
				...
				<td>
					<input class="inputbox" type="text" name="config[priority_newsletter]" size="10" value="<?php echo intval($this->config->get('priority_newsletter',3)); ?>">
				</td>
			</tr>
			<tr>
				<td class="key">
				...
				<td>
					<input class="inputbox" type="text" name="config[priority_followup]" size="10" value="<?php echo intval($this->config->get('priority_followup',2)); ?>">
				</td>
			</tr>
		</table>
	</fieldset>
