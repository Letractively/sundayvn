...
<?php if($this->config->get('require_confirmation')){ ?>
	<tr id="trfileconfirm">
		...
		<td>
			<?php
				echo JHTML::_('select.booleanlist', "zoho_confirmed" , '',$this->config->get('zoho_confirmed'),JText::_('JOOMEXT_YES'),JTEXT::_('JOOMEXT_NO') );
			?>
		</td>
	</tr>
	<?php } ?>
	<tr id="trfileoverwrite">
		...
		<td>
			<?php
			echo JHTML::_('select.booleanlist', "zoho_overwrite" , '',$this->config->get('zoho_overwrite'),JText::_('JOOMEXT_YES'),JTEXT::_('JOOMEXT_NO') ); ?>
		</td>
	</tr>
	<tr id="trfileoverwrite">
		<td class="key" >
		...
		<td>
			<?php
			echo JHTML::_('select.booleanlist', "zoho_delete" , '',$this->config->get('zoho_delete'),JText::_('JOOMEXT_YES'),JTEXT::_('JOOMEXT_NO') ); ?>
		</td>
	</tr>
	<tr id="trfileoverwrite">
		<td class="key" >
...
<legend><?php echo JText::_('FIELD'); ?></legend>
		...
		$tableFields = $db->getTableFields('#__acymailing_subscriber');
		$subfields = reset($tableFields);
		$acyfields = array();
