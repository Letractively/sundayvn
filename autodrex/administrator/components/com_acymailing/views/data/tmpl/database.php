...
<?php
	$db = JFactory::getDBO();
	$fields = $db->getTableFields('#__acymailing_subscriber');
	$subfields = reset($fields);
	$postFields = JRequest::getVar('fields',array());
	?>
<table class="admintable" cellspacing="1">
<tr><td class="key"><?php echo JText::_('TABLENAME'); ?></td><td><input type="text" name="tablename" size="80" value="<?php echo $this->escape(JRequest::getString('tablename','')); ?>" /></td></tr>
	<?php
