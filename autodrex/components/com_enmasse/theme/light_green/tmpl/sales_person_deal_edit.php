...
<form action="index.php" method="post" name="adminForm" id="adminForm" class="form-validate" >
	...
	<table class="admintable">
        ...
        <tr>
            ...
            * </label></td>
            <td><?php echo JHtml::_('select.genericList', $prepayList, 'prepay_percent', null, 'value', 'text', is_null($row->prepay_percent)? 100 : $row->prepay_percent, 'prepay_percent')?><span>%</span></td>
        </tr>        
		<tr>
			<td align="right" class="key">
				<label for="price">
