...
<div align="center" class="row btn_orange">
	...
	<p style="text-align:center;margin-bottom: 15px;"><a onclick="dotooglemore()"  id="showMore"  style="background: #6BE2E7;border: none;color: black;font-weight: bold;padding: 5px 12px;margin-top: 10px;-webkit-border-radius: 7px;border-radius: 7px;">More information</a></p>
