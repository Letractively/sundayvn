...
<form action="index.php" method="post" name="adminForm" id="adminForm" class="form-validate" >
	...
	<table class="admintable">
		...
		<tr>
			...
			<td>
				<input class="required text" type="text" name="name" id="name" size="45" maxlength="250" value="<?php echo $row->name;?>" />
				<input class="text" type="hidden"  name="tempName" value="<?php echo $row->name;?>" />
				</td>
		</tr>
		<tr>
			<td align="right" class="key">
			...
			<td>
				<?php 
					...
					echo $editor->display('description', $row->description, '300', '200', 3, 50);
				?>
			</td>
		</tr>
		<tr>
			...
			<td>
				<textarea class="text_area text" name="short_desc" id="short_desc" rows="3" cols="50"><?php echo $row->short_desc;?></textarea>
			</td>
		</tr>
		<tr>
			<td align="right" class="key">
			...
			<td>
				<input class="text_area text" type="text" name="origin_price" id="origin_price" size="20" maxlength="250"
		...
		<tr>
			...
			<td>
				<input class="text_area text" type="text" name="price" id="price" size="20" maxlength="250" value="<?php echo $row->price;?>" />
				<span><?php echo $this->currencyPostfix;?></span>
			</td>
		</tr>
		<tr>
			...
			<td>
				...
				<input class="text_area text" type="text" name="pic_dir" id="pic_dir"
				size="50" maxlength="250" value="<?php echo $row->pic_dir;?>" />
								
				<a rel="{handler: 'iframe', size: {x: 500, y: 400}}"
				href="<?php echo 'index.php?option=com_enmasse&controller=uploader&task=display&tmpl=component&parentId=pic_dir'; ?>"
		...
		<tr>
			...
			<?php
	                if(substr($joomla,0,3) >= 1.6){
	            	    echo JHTML::_('calendar',$row->start_at, 'start_at','start_at','%Y-%m-%d' , array('size'=>30, 'readonly'=>''));
	                }else{
	            ?>
	                    <input type="text" name="start_at" id="start_at" value="<?php echo $row->start_at ?>" size="30" class="text"  readonly/> 
		...
		<tr>
			...
			<td>
				<?php
	                if(substr($joomla,0,3) >= 1.6){
	            	    echo JHTML::_('calendar',$row->end_at, 'end_at','end_at','%Y-%m-%d' , array('size'=>30, 'readonly'=>''));
	                }else{
	            ?>
	                    <input type="text" class="text" name="end_at" id="end_at"
	            			value="<?php echo $row->end_at ?>" size="30" readonly> <input type="reset"
	            			class="button" value="..."
		...
		<tr>
			...
			<td>
				<input type="text" class="text" name="min_needed_qty" id="min_needed_qty"
		...
		<tr>
			...
			<td>
				<input type="text" class="text" name="max_buy_qty" id="max_buy_qty"
		...
		<tr>
			...
			<td>
				<input class="text"  type="text" name="max_coupon_qty" id="max_coupon_qty"
		...
		<tr>
			...
			<td>
				<?php 
					$editor = JFactory::getEditor();
					echo $editor->display('highlight', $row->highlight, '300', '200', 3, 50);
				?>
			</td>
		</tr>
		<tr>
			...
			<td>
				<?php 
					$editor = JFactory::getEditor();
					echo $editor->display('terms', $row->terms, '300', '200', 3, 50);
				?>
			</td>
		</tr>
		<?php if(!empty($row->id)):?>
